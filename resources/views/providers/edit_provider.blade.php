            ...
            <div class="row mb-2">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="last_name" id="last_name"
                           placeholder="أدخل لقب المزود" value="{{old('last_name') ?? $provider->person->last_name}}">
                    @error('last_name')
            ...
            <div class="row mb-2">
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="establishment"
                           id="establishment"
                           placeholder="أدخل اسم المؤسسة" value="{{old('establishment') ?? $provider->person->establishment}}">
                    @error('establishment')
                    <div class="form-text text-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="address" id="address"
                           placeholder="أدخل عنوان المزود" value="{{old('address') ?? $provider->person->address}}">
                    @error('address')
                    <div class="form-text text-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" pattern="\d*" maxlength="10" class="form-control" name="phone2" id="phone2"
                           placeholder="أدخل رقم هاتف المزود"
                            @if($provider->person->phone2 != null)
                                value="{{old('phone2') ?? 0 . $provider->person->phone2}}"
                            @endif>
                    @error('phone2')
                    <div class="form-text text-danger">{{$message}}</div>
                    @enderror
