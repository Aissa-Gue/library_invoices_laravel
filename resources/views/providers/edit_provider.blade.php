...
@section('content')
    ...
    <form action="{{ Route('editProvider', $provider->person->id) }}" method="post">
        @csrf
        @method('PUT')
        <fieldset class="scheduler-border">
            ...
            <div class="row mb-2">
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control text-center" name="client_id" id="client_id"
                        value="{{ $provider->person->id }}" placeholder="أدخل رقم المزود">
                </div>
            </div>
            ...
            <div class="row mb-2">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="last_name" id="last_name" placeholder="أدخل لقب المزود"
                        value="{{ old('last_name') ?? $provider->person->last_name }}">
                    @error('last_name')
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="first_name" id="first_name"
                        placeholder="أدخل اسم المزود" value="{{ old('first_name') ?? $provider->person->first_name }}">
                    @error('first_name')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="father_name" id="father_name"
                        placeholder="أدخل اسم الأب" value="{{ old('father_name') ?? $provider->person->father_name }}">
                    @error('father_name')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-2">
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="establishment" id="establishment"
                        ...
                        value="{{ old('establishment') ?? $provider->person->establishment }}">
                    @error('establishment')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="address" id="address" placeholder="أدخل عنوان المزود"
                        value="{{ old('address') ?? $provider->person->address }}">
                    @error('address')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-2">
                <div class="col-md-4">
                    ...
                    <input type="text" pattern="\d*" maxlength="10" class="form-control" name="phone1" id="phone1"
                        placeholder="أدخل رقم هاتف المزود" value="{{ old('phone1') ?? 0 . $provider->person->phone1 }}">
                    @error('phone1')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" pattern="\d*" maxlength="10" class="form-control" name="phone2" id="phone2"
                        ...
                        @if ($provider->person->phone2 != null) value="{{ old('phone2') ?? 0 . $provider->person->phone2 }}" @endif>
                    @error('phone2')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
