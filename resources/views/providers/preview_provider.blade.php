            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="row py-1">
                        ...
                        <td class="col-md-6 text-success fw-bold">
                            {{ number_format($details->total_required_amount, 2) }}دج
                        </td>
                    </tr>
                    <tr class="row py-1">
                    ...
                    <tr class="row py-1">
                        <td class="col-md-11 text-center">
                            <form action="{{ route('deleteProvider', $provider->person->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('editProvider', $provider->person->id) }}"
                                    class="btn btn-primary px-4"><i class="fas fa-user-edit"></i> تعديل</a>
