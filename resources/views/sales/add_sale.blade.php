        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-danger fw-bold text-center">{{ number_format($book_data['totalSalePrice'], 2) }} دج
                    </td>
                    <td class="text-center">
                        <button type="submit" onclick="event.preventDefault();
                                document.getElementById('saleForm').submit();" class="btn btn-success rounded-pill px-4"><i
                                class="fas fa-shopping-cart"></i> بيع
                        </button>
                    </td>
                </tr>
            </tbody>
    ...
    @if (session()->has('message'))
        <div class="alert alert-success alert-dismissible fade show fw-bold d-flex align-items-center mt-4" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                class="bi bi-check-circle-fill me-3" viewBox="0 0 16 16" role="img">
                <path
