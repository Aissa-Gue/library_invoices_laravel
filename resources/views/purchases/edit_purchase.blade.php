...
@section('content')
        ...
        <div class="row my-3">
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="text" name="purchase_id" class="form-control text-center"
                           value="{{$purchase->id}}" id="purchase_id" readonly>
                </div>
            </div>
        </div>
    ...
    <fieldset class="scheduler-border">
                        ...
                        <div class="modal-body text-center text-danger">
                            ...
                            <div class="row">
                                ...
                                <h6 class="text-dark text-start fw-bold col-md-4"># سعر الشراء القديم:
                                    <span
                                        class="text-danger fw-bolder">{{session()->get('oldPurchasePrice')}} دج </span>
                                </h6>
        ...
        @foreach($purchaseBooks as $purchaseBook)
            <div class="row mt-1">
                <div class="col-md-5">
                    <input value="{{$purchaseBook->book->title}}" class="form-control" id="title"
                           disabled>
                </div>
                ...
                <div class="col-md-2">
                    <input type="text" class="form-control text-center" id="purchase_price_sum"
                           value="{{number_format($purchaseBook->purchase_price * $purchaseBook->quantity,2)}}"
                           disabled>
                </div>

                <div class="col-md-1">
                    <form action="{{Route('deletePurchaseBook',array($purchase->id,$purchaseBook->book_id))}}"
                          method="post">
                        @csrf
                        @method('DELETE')
