                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-10 mb-2">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="أدخل عنوان الكتاب"
                                value="{{ old('title') }}">
                            @error('title')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control text-center" name="publication_year"
                                id="publication_year" placeholder="أدخل سنة النشر" value="{{ old('publication_year') }}">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="edition" id="edition" placeholder="أدخل الطبعة"
                                value="{{ old('edition') }}">
                            @error('edition')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
    ...
    @enderror
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select text-center" id="sale_percentage" name="sale_percentage"
                                value="{{ old('sale_percentage') }}" required>
