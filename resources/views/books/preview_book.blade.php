            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="row py-1">
                        ...
                        <td class="col-md-6">
                            {{ $book->purchase_price + ($book->purchase_price * $book->sale_percentage) / 100 }}.00 دج
                        </td>
                    </tr>
                    <tr class="row mt-4">
                        <td class="col-md-11 text-center">
                            <form action="{{ route('deleteBook', $book->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('editBook', $book->id) }}" class="btn btn-primary px-4"><i
                                        class="fas fa-pencil"></i> تعديل</a>
