                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="sale_percentage" class="form-control text-center" id="sale_percentage">
                                ...
                                <option value="15" @if ($book->sale_percentage == 15) {{ 'selected' }} @endif>15%
                                </option>
                                <option value="20" @if ($book->sale_percentage == 20) {{ 'selected' }} @endif>20%
                                </option>
                                <option value="25" @if ($book->sale_percentage == 25) {{ 'selected' }} @endif>25%
                                </option>
                                <option value="30" @if ($book->sale_percentage == 30) {{ 'selected' }} @endif>30%
                                </option>
                            </select>
