...
<div id="navigation">
    <ul class="nav nav-pills mb-4 fw-bold justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{Route::is('settingsClients') ? 'active' : ''}}" href="{{Route('settingsClients')}}"><i
                    class="fas fa-user"></i> قائمة الزبائن</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{Route::is('settingsProviders') ? 'active' : ''}}" href="{{Route('settingsProviders')}}"><i
