...
<div class="my_fixed_sidebar">
    ...
    <div class="nav flex-column nav-pills" id="myTab" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link {{Request::is('trash/*') ? 'active' : ''}}" href="{{Route('trashedBooks')}}">
        ...
        <a class="nav-link {{Route::is('addBook') ? 'active' : ''}}" href="{{Route('addBook')}}">
        ...
        <a class="nav-link {{Route::is('booksList') ? 'active' : ''}}" href="{{Route('booksList')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a class="nav-link {{Route::is('clientsList') ? 'active' : ''}}" href="{{Route('clientsList')}}">
        ...
        <a class="nav-link {{Route::is('addSale') ? 'active' : ''}}" href="{{Route('addSale')}}">
        ...
        <a class="nav-link {{Route::is('ordersList') ? 'active' : ''}}" href="{{Route('ordersList')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                 class="bi bi-list-check" viewBox="0 0 16 16">
                <path fill-rule="evenodd"
                      d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0zm0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0zm0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0z"/>
        ...
        <a class="nav-link {{Request::is('settings/*') ? 'active' : ''}}" href="{{Route('settingsDatabase')}}">
