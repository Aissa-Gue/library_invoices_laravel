            ...
            <div class="row mb-2">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="last_name" id="last_name"
                           placeholder="أدخل لقب الزبون" value="{{old('last_name') ?? $client->person->last_name}}">
                    @error('last_name')
            ...
            <div class="row mb-2">
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="address" id="address"
                           placeholder="أدخل عنوان الزبون" value="{{old('address') ?? $client->person->address}}">
                    @error('address')
                    <div class="form-text text-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" pattern="\d*" maxlength="10" class="form-control" name="phone2" id="phone2"
                           placeholder="أدخل رقم هاتف الزبون"
                            @if($client->person->phone2 != null)
                                value="{{old('phone2') ?? 0 . $client->person->phone2}}">
                            @endif
                    @error('phone2')
                    <div class="form-text text-danger">{{$message}}</div>
                    @enderror
