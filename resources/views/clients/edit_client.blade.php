...
@section('content')
    ...
    <form action="{{ Route('editClient', $client->person->id) }}" method="post">
        @csrf
        @method('PUT')
        <fieldset class="scheduler-border">
            ...
            <div class="row mb-2">
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control text-center" name="client_id" id="client_id"
                        value="{{ $client->person->id }}" placeholder="أدخل رقم الزبون">
                </div>
            </div>
            ...
            <div class="row mb-2">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="last_name" id="last_name" placeholder="أدخل لقب الزبون"
                        value="{{ old('last_name') ?? $client->person->last_name }}">
                    @error('last_name')
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="first_name" id="first_name"
                        placeholder="أدخل اسم الزبون" value="{{ old('first_name') ?? $client->person->first_name }}">
                    @error('first_name')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="father_name" id="father_name"
                        placeholder="أدخل اسم الأب" value="{{ old('father_name') ?? $client->person->father_name }}">
                    @error('father_name')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-2">
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="address" id="address" placeholder="أدخل عنوان الزبون"
                        value="{{ old('address') ?? $client->person->address }}">
                    @error('address')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-2">
                <div class="col-md-4">
                    ...
                    <input type="text" pattern="\d*" maxlength="10" class="form-control" name="phone1" id="phone1"
                        placeholder="أدخل رقم هاتف الزبون" value="{{ old('phone1') ?? 0 . $client->person->phone1 }}">
                    @error('phone1')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" pattern="\d*" maxlength="10" class="form-control" name="phone2" id="phone2"
                        ...
                        @if ($client->person->phone2 != null) value="{{ old('phone2') ?? 0 . $client->person->phone2 }}"> @endif
                        @error('phone2') <div class="form-text text-danger">{{ $message }}</div> @enderror </div>
                </div>
