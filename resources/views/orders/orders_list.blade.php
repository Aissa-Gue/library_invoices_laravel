...
@section('content')
    @if (Auth::user()->role == 'admin')
        @include(
            'includes.navbars.orders-purchases.navigation_list'
        )
    @endif
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="type" id="type">
                                ...
                                <option value="بيع" @if (request('type') == 'بيع') {{ 'selected' }} @endif>بيع
                                </option>
                                <option value="معرض" @if (request('type') == 'معرض') {{ 'selected' }} @endif>معرض
                                </option>
                                @if (Auth::user()->role == 'admin')
        ...
        <tbody>
            ...
            @empty
                <div class="alert alert-danger text-center" role="alert">
                    ...
                    <strong>{{ request('order_id') }} ~ {{ request('type') }}
            ...
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-outline-success" href="{{ route('previewOrder', $order->id) }}">
                    ...
                    <td class="text-center">
                        <a class="btn btn-outline-primary" href="{{ route('editOrder', $order->id) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
