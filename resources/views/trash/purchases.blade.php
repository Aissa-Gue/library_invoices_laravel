    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="alert alert-danger text-center" role="alert">
                <h5><i class="fas fa-file-invoice-dollar"></i> فواتير المزودين المحذوفة</h5>
            </div>
        </div>
                ...
                @foreach($trashedPurchases as $trashedPurchase)
                    <tr class="fw-bold">
                        ...
                        <td class="text-center">
                            <form action="{{route('restoreTrashedPurchase', $trashedPurchase->id)}}" method="POST">
                                @csrf
                        ...
                        <td class="text-center">
                            <form action="{{route('deleteTrashedPurchase', $trashedPurchase->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
