        ...
        <div class="col-md-12">
            <div class="mx-1 flex-md-fill bd-highlight shadow bg-body rounded p-2">
                ...
                <div class="row justify-content-sm-center mb-3">
                    <div class="col-sm-7">
                        <form action="{{Route('providersDebts')}}" method="get">
                ...
                <table class="table table-hover caption-top m-0">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="text-center">المزود</th>
                    </tr>
                    </thead>
                    <tbody>
                    @if($debts->isEmpty())
                    ...
                    @foreach($debts as $debt)
                        <tr>
                            ...
                            <th scope="row" class="text-center"><a href="{{Route('previewPurchase',$debt->id)}}" class="btn btn-outline-success"><i class="fad fa-shopping-cart"></i></a></th>
                            <th scope="row" class="text-center"><a href="{{Route('previewProvider',$debt->provider_id)}}" class="btn btn-outline-primary"><i class="fas fa-user-tie"></i></a></th>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
